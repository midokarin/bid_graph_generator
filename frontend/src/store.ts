...
export const useWorkspace=create<State>((set,get)=>({activeKind:'flowchart',selections:{flowchart:null,gantt:null},histories:{flowchart:[],gantt:[]},versions:[],activeRevision:null,dirty:false,dirtyKinds:{flowchart:false,gantt:false},
